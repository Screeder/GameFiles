...
{
	internal class DefineFont2_3 : ISwfTag
	{
		/*
		...
		*/
		...
		internal bool FontFlagsHasLayout;	
		internal bool FontFlagsShiftJIS;	
		internal bool FontFlagsSmallText;	
		internal bool FontFlagsANSI;		
		internal bool FontFlagsWideOffsets;
		internal bool FontFlagsWideCodes;	
		internal bool FontFlagsItalic;		
		internal bool FontFlagsBold;	
	
		internal uint LanguageCode;			
		internal string FontName;			
		internal uint NumGlyphs;			
		internal uint[] OffsetTable;			
		internal uint CodeTableOffset;
		internal List<Shape> GlyphShapeTable;		
		internal uint[] CodeTable;		
		internal int FontAscent;			
		internal int FontDescent;			
		internal int FontLeading;			
		internal int[] FontAdvanceTable;	
		internal Rect[] FontBoundsTable;		
		internal uint KerningCount;	
		internal KerningRecord[] FontKerningTable;

		internal bool IsHighRes = false;
