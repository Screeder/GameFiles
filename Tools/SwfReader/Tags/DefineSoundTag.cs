...
namespace LeagueSharp.GameFiles.Tools.Swf
{
	...
	*/
	internal class DefineSoundTag : IControlTag
	{
		internal uint SoundId;
		internal SoundCompressionType SoundFormat;
		internal uint SoundRate;
		internal uint SoundSize;
		internal bool IsStereo;
		internal uint SoundSampleCount;
