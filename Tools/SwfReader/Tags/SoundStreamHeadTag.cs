...
{
	internal class SoundStreamHeadTag : IControlTag
	{
		/*
		...
		internal static readonly string[] SoundExtentions = new string[]
		{
			".wav",
			".wav",
			".mp3",
		...
		internal uint PlaybackSoundRate;
		internal uint PlaybackSoundSize;
		internal bool IsStereo;
		internal SoundCompressionType StreamSoundCompression;
		internal uint StreamSoundRate;
		internal uint StreamSoundSize;
		internal bool StreamIsStereo;
		internal uint StreamSoundSampleCount;
		internal uint LatencySeek;
