...
{
	internal class StyleChangedRecord : IShapeRecord
	{
		/*
			STYLECHANGERECORD
			Field				Type					Comment
		...
		internal int  MoveDeltaX;
		internal int  MoveDeltaY;
		internal uint FillStyle1;
		internal uint FillStyle0;
		internal uint LineStyle;
		internal FillStyleArray FillStyles;
		internal LineStyleArray LineStyles;
		internal bool HasMove;
		internal bool HasFillStyle0;
		internal bool HasFillStyle1;
		internal bool HasLineStyle;
		internal bool HasNewStyles;
