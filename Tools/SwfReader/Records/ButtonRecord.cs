...
namespace LeagueSharp.GameFiles.Tools.Swf
{
    internal class ButtonRecord
	{
        ...
        internal bool ButtonHasBlendMode;                    
        internal bool ButtonHasFilterList;                   
        internal bool ButtonStateHitTest;
        internal bool ButtonStateDown;   
        internal bool ButtonStateOver;   
        internal bool ButtonStateUp;      
        internal uint CharacterID;
        internal uint PlaceDepth;        
        internal Matrix PlaceMatrix;
        internal ColorTransform ColorTransform; 
        internal List<IFilter> FilterList;   
        internal BlendMode BlendMode;

        internal uint containerTag;
