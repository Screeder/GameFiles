...
namespace LeagueSharp.GameFiles.Tools.Swf
{
	internal class Matrix : IRecord
	{
		...
		*/
		...
		internal static Matrix Empty = new Matrix(0, 0, 0, 0, 0, 0);
		internal static Matrix Identity = new Matrix(1, 0, 0, 1, 0, 0);

		internal float ScaleX;
		internal float ScaleY;
		internal float Rotate0;
		internal float Rotate1;
		internal float TranslateX;
		internal float TranslateY;

		internal Matrix(float scaleX, float rotate0, float rotate1, float scaleY, float translateX, float translateY)
		{
			this.ScaleX = scaleX;
