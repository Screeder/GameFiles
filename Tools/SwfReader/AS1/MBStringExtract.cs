...
{
	internal class MBStringExtract : IStackManipulator
	{
		internal ActionKind ActionId{get{return ActionKind.MBStringExtract;}}
		...
		{
			w.WriteLine("mbsubstring");
		}
#endif
#if SWFWRITER
		internal override void ToSwf(SwfWriter w)
		{
            w.AppendByte((byte)ActionKind.MBStringExtract);
		}
#endif
#if SWFDUMPER
