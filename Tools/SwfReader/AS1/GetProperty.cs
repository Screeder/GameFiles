...
{
	internal class GetProperty : IStackManipulator
	{
		internal ActionKind ActionId{get{return ActionKind.GetProperty;}}
		...
		{
			w.WriteLine("getproperty");
		}
#endif
#if SWFWRITER
		internal override void ToSwf(SwfWriter w)
        {
            w.AppendByte((byte)ActionKind.GetProperty);
		}
#endif
#if SWFDUMPER
