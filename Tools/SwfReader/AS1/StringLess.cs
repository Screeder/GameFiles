...
{
	internal class StringLess : IStackManipulator
	{
		internal ActionKind ActionId{get{return ActionKind.StringLess;}}
		...
		{
			w.WriteLine("stringlessthan");
		}
#endif
#if SWFWRITER
		internal override void ToSwf(SwfWriter w)
		{
            w.AppendByte((byte)ActionKind.StringLess);
		}
#endif
#if SWFDUMPER
