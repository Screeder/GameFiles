...
{
	internal class StringEquals : IStackManipulator
	{
		internal ActionKind ActionId{get{return ActionKind.StringEquals;}}
		...
		{
			w.WriteLine("stringeq");
		}
#endif
#if SWFWRITER
		internal override void ToSwf(SwfWriter w)
        {
            w.AppendByte((byte)ActionKind.StringEquals);
		}
#endif
#if SWFDUMPER
