...
{
	internal class Subtract : IStackManipulator
	{
		internal ActionKind ActionId{get{return ActionKind.Subtract;}}
		...
		{
			w.WriteLine("subtract");
		}
#endif
#if SWFWRITER
		internal override void ToSwf(SwfWriter w)
        {
            w.AppendByte((byte)ActionKind.Subtract);
		}
#endif
#if SWFDUMPER
