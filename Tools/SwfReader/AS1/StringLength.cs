...
{
	internal class StringLength : IStackManipulator
	{
		internal ActionKind ActionId{get{return ActionKind.StringLength;}}
		...
		{
			w.WriteLine("stringlength");
		}
#endif
#if SWFWRITER
		internal override void ToSwf(SwfWriter w)
		{
            w.AppendByte((byte)ActionKind.StringLength);
		}
#endif
#if SWFDUMPER
